...
export default function SignupPage() {
  ...
  const headline = settings?.authHeadline || "Why join?";
  const subheadline = settings?.authSubheadline || "";
  const feature1 = settings?.authFeature1 || "Book rooms with real-time availability";
  const feature2 = settings?.authFeature2 || "Instant confirmation after approval";
  const feature3 = settings?.authFeature3 || "Manage all reservations in one place";
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <div className="aspect-[4/3] rounded-md overflow-hidden">
                <img src={authHero1} alt="Spaces" className="w-full h-full object-cover" />
              </div>
              <p className="text-sm font-medium">Spaces you can book</p>
            </div>
            <div className="space-y-2">
              <div className="aspect-[4/3] rounded-md overflow-hidden">
                <img src={authHero2} alt="Events" className="w-full h-full object-cover" />
              </div>
